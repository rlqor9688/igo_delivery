...
public class ReviewServiceFindTest {
    ...
    void 리뷰_조회에_성공한다() {
        ...
        given(reviewRepository.findAllByStoresIdAndRatingRange(store.getId(), 1, 5)).willReturn(List.of(review));
        ...
        verify(reviewRepository).findAllByStoresIdAndRatingRange(review.getId(), 1, 5);
    }
